#!/usr/bin/env bash
# Job 017b: SA3 smoke test v2 (generate_diffusion_cond_inpaint). Finds a conda env with stable_audio_tools, inspects how ~/Desktop/amg drove SA3,
...
export W2S_RESULTS="results/017b_sa3_smoke_v2"
